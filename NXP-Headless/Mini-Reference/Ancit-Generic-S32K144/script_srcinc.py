...
from mqtt_server import transmit_srec
...
S32DS_ROOT_DIR  := E:/Software/NXP/S32DS/build_tools/gcc_b1620
NXP_K144_RTM    := E:/Software/NXP/S32DS/software/S32SDK_S32K1XX_RTM_4.0.1
...
def main():
    ...
    run_command("make srec", "generate srec file")
    ...
    pad_srec("build/SubSys_Mini_HeadLight_fota_aligned.srec","build/SubSys_Mini_HeadLight_fota_aligned_padded.srec")


    # # Start the MQTT backend [pyserial for test purpose, MQTT in real environment]

    transmit_srec(port="COM25",baudrate=115200,srec_file="build/SubSys_Mini_HeadLight_fota_aligned_padded.srec")
